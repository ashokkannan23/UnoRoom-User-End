(() => {
    ...
    function creationRoomWidgetHeader(roomName) {
        var html = '<div class="col-xl-12 col-lg-12 col-md-12 bg-light"  style="clear:both;border:1px solid #CFCDCE;border-radius:10px;padding:10px;background:#E5E5E5;margin-bottom:20px;">' +
            '<div class="row">' +
